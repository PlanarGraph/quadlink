defmodule QuadlinkWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Quadlink.MyChannel do
        use QuadlinkWeb, :channel
        alias QuadlinkWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :quadlink,
                        pubsub_server: Quadlink.PubSub
end
